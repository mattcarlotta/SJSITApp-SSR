module.exports = (
  ...
  <div style="margin-bottom: 20px; text-align: center;">
    <a style="font-size: 18px; text-decoration: none; line-height: 40px; width: 200px; color: #FFFFFF; background-color: #025f6d; display: inline-block;" href="${LOCALHOST}/employee/login" target="_blank" rel="noopener noreferrer">Employee Login</a>
  </div>
