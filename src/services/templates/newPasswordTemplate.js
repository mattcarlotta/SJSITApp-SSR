module.exports = (
  ...
  <div style="margin-bottom: 20px; text-align: center">
    <a style="font-size: 18px;text-decoration: none;line-height: 40px;width: 200px;color: #FFFFFF;background: linear-gradient(90deg,#194048 0%,#0f7888 50%,#194048 100%);border-radius: 4px;display: inline-block;border: 2px solid #04515d;" href="${LOCALHOST}/employee/newpassword/verify?token=${token}" target="_blank" rel="noopener noreferrer">Create New Password</a>
  </div>
