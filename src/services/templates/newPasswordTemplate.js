export default (
  ...
  <div style="color:#999999;font-size:11px;text-align:center;margin-top: 10px;">
    ...
    <a style="color: #999999; text-decoration: underline; margin-left: 2px;" href="${LOCALHOST}/employee/newpassword/verify?token=${token}" target="_blank" rel="noopener noreferrer">${LOCALHOST}/employee/newpassword/verify?token=${token}</a>
  </div>`;
