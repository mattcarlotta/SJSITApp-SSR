		...
		<DragDropContext onDragEnd={handleDrag}>
			<Container>
				...
				<GameDetailsContainer>
					<div css="text-align: center;color: #fff;background: linear-gradient(90deg,#194048 0%,#0f7888 50%,#194048 100%);border-radius: 3px;padding: 10px 5px;text-transform: uppercase;font-size: 17px;text-shadow: 1px 2px 2px #000000;">
						{event.team}{" "}
						{event.opponent && (
							<>
								<span
