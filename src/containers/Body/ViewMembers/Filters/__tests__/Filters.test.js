...
describe("Event Filters", () => {
	...
	it("handles Status filters", () => {
		wrapper.find("#status").first().simulate("click");
	...
	it("handles Email filters", () => {
		...
		wrapper.find("#email").first().simulate("click");
	...
	it("handles First Name filters", () => {
		...
		wrapper.find("#first-name").first().simulate("click");
	...
	it("handles Last Name filters", () => {
		...
		wrapper.find("#last-name").first().simulate("click");
	...
	it("clicking on the 'Add Member' button, moves the user to the New Member Form page", () => {
		wrapper.find("Button.add-member").at(0).simulate("click");
